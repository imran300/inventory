                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <?php if (!empty($order_details)): foreach ($order_details as $v_order) : ?>
                                            <tr>
                                                ...
                                                <td class="unit"><?php echo currency(number_format($v_order->purchase_rate, 2)); ?></td>
                                                <?php
                                               ...
                                               $t = $sales_qty * $total_buying_price;
												...
												<td class="unit"><?php echo currency(number_format($v_order->purchase_amount, 2)) ?></td>
                                                
                                                <td class="total"><?php echo currency(number_format($v_order->purchase_amount,2)); ?></td>
                                            </tr>
                                            <?php $k++ ?>
